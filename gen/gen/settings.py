...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    "mastersvarki-change-me-please-use-env-secret-key-2026-strong-value",
)
...
OWNER_EMAIL = os.getenv("OWNER_EMAIL", "ilyin.rostislaw@gmail.com").strip().lower()
...
ARTICLE_MAX_CONTENT_LENGTH = int(os.getenv("ARTICLE_MAX_CONTENT_LENGTH", "20000"))
ARTICLE_MAX_IMAGES = int(os.getenv("ARTICLE_MAX_IMAGES", "7"))
ARTICLE_IMAGE_MAX_MB = int(os.getenv("ARTICLE_IMAGE_MAX_MB", "10"))
...
TELEGRAM_AUTH_CODE_TTL_MINUTES = int(
    os.getenv("TELEGRAM_AUTH_CODE_TTL_MINUTES", str(AUTH_CODE_TTL_MINUTES))
)
TELEGRAM_AUTH_CODE_MAX_ATTEMPTS = int(
    os.getenv("TELEGRAM_AUTH_CODE_MAX_ATTEMPTS", str(AUTH_CODE_MAX_ATTEMPTS))
)
TELEGRAM_AUTH_RESEND_SECONDS = int(os.getenv("TELEGRAM_AUTH_RESEND_SECONDS", "45"))
